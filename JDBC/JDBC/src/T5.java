...
class DigitalLibraryManagement{
    ...
    {
        map.put(1,"EE : Microelectronic Circuits");
        map.put(2,"EE : Digital Design");
        map.put(3,"EE : Fundamentals of Electric Power");
        map.put(4,"EE : Control Systems Engineering");
        map.put(5,"EE : Communication Systems");
        map.put(6,"EE : Signals and Systems");
        map.put(7,"EE : Power System Analysis and Design");
        map.put(8,"ECE : Analog Circuits");
        map.put(9,"ECE : Wireless Communications");
        map.put(10,"ECE : Introduction to Electric Circuits");
        map.put(11,"ECE : Analog Integrated Circuit Design");
        map.put(12,"CSE : C++ Programming");
        map.put(13,"CSE : Java Programming");
        map.put(14,"CSE : Python Programming");
        map.put(15,"CSE : C# Programming");
    ...
    public void admin_login()
    {
        ...
        loginto.put("kavya",1986);
        loginto.put("kav",1234);
    ...
    public void user_login()
    {
        ...
        loginto.put("janu",1234);
        loginto.put("anju",5678);
        loginto.put("likki",2003);
        loginto.put("megh",2004);
