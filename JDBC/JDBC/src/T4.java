...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: Which of the following is not a java feature?");  
        ...
        if(current==2)  
        {  
            l.setText("Que3: What does the expression float a=35/0 return?");  
            jb[0].setText("0");jb[1].setText("Not a number ");jb[2].setText("Infinity");jb[3].setText("Run time exception");  
        }  
        if(current==3)  
        {  
            l.setText("Que4:which of the following is a reserved keyword in Java?");  
