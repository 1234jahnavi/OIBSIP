    ...
    public class T1 {
        ...
        public static class user {
            ...
            public String getUsername() {
                System.out.println(" janu Enter Username : ");
                username = sc.nextLine();
                return username;
            }
    
            public String getPassword() {
                System.out.println("janu Enter Password : ");
        ...
        public static void main(String[] args) {
            ...
            String url = "jdbc:mysql://localhost:3306/janu";
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
    
                try (Connection connection = DriverManager.getConnection(url, "root", "W7301@jqir#")) {
